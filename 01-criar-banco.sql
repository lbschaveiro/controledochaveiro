...
-- ------------------------------------------------------------
-- Recursos das versoes 5 e 6 (MANTER EM SINCRONIA com 02-atualizar-banco.sql):
...
-- ============================================================
-- PRONTO! Banco criado na versao 6, pronto para uso.
-- Login inicial: admin / admin123  (troque a senha no app)
-- ============================================================
